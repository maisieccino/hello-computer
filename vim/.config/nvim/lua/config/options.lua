...
if util.is_work() then
  ...
  -- opt.rtp:append(vim.fn.expand("~/src/github.com/monzo/wearedev-ruleperf/tools/editors/nvim/pin.nvim"))
end
...
if vim.fn.isdirectory(vim.fn.expand("~/.local/share/virtualenvs/nvim")) == 1 then
